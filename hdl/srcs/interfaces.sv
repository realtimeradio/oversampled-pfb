...
// fixed-point data interface with convenience methods for interpreting the values
interface fp_data #(
  ...
  // display parameters
  localparam real lsb_scale = 0;//1.0/(2**f);
...
// note: interfacing to a VHDL/Verilog instance requires accessing the individual elements of
// the data field (e.g., s_axis.tdata[0]) to get the conversion to work
...
/*
  wrapper interfaces for xilinx fft
*/
...
// Legacy interfaces, mainly examples of simple interfaces
